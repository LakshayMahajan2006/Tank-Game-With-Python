...
pygame.display.set_caption('Tanks - Lakshay Mahajan')
...
def game_controls():
    ...
    while gcont:
        ...
        message_to_screen("Press D to raise Power. Press A to lower Power. ", wheat, 140)
...
def game_intro():
    ...
    while intro:
        ...
        gameDisplay.fill(black)
        message_to_screen("Welcome to Tanks Game!", white, -100, size="large")
        ...
        message_to_screen("Created by :- Lakshay Mahajan", wheat, 280)
